...
internal fun SoundCloudCatalog.Track.toSoundCloudMetadata() = MediaMetadata(
...
internal fun SoundCloudCatalog.Track.toSoundCloudMediaItem(stream: SoundCloudNewPipe.Stream) =
    buildSoundCloudMediaItem(stream.url, stream.isHls)

internal fun SoundCloudCatalog.Track.toCachedSoundCloudMediaItem() =
    buildSoundCloudMediaItem(permalink, false)

private fun SoundCloudCatalog.Track.buildSoundCloudMediaItem(uri: String, isHls: Boolean): MediaItem {
    ...
    return MediaItem.Builder()
        ...
        .setMediaMetadata(
            androidx.media3.common.MediaMetadata.Builder()
                .setTitle(title).setSubtitle(artist).setArtist(artist)
                .setArtworkUri(artworkUrl?.toUri()).setMediaType(MEDIA_TYPE_MUSIC).build()
        ).build()
}
